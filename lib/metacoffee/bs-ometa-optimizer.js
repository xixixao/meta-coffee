define([ "./ometa-base", "./ometa-lib" ], function(OMeta, OMLib) {
  ...
  subclass = OMLib.subclass, propertyNames = OMLib.propertyNames, programString = OMLib.programString, 
  extend = OMLib.extend;
  ...
  BSSeqInliner = subclass(BSNullOptimization, {
    ...
    inlineChar: function() {
      var BSOMetaParser, c;
      return function() {
        BSOMetaParser = OMeta.interpreters.BSOMetaParser;
  ...
  JumpTable = function() {
    ...
    JumpTable.prototype.toTree = function() {
      ...
      for (_i = 0, _len = choiceKeys.length; _len > _i; _i++) {
