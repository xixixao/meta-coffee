(function() {
  ...
  BSCSParser = subclass(OMeta, {
    ...
    "compile": function() {
      ...
      return (function() {
        at = this._idxConsumedBy((function() {
          return (function() {
            input = this._apply("anything");
            return args = this._apply("anything")
          }).call(this)
        }));
    ...
    "simplify": function() {
      ...
      return (function() {
        at = this._idxConsumedBy((function() {
          return compiled = this._apply("anything")
        }));
        return (function() {
          var exp, lines;
  ...
  BSSemActionParser = subclass(BSDentParser, {
    ...
    "pairOf": function() {
      ...
      return (function() {
        ...
        e = this._apply("anything");
        at = this._idxConsumedBy((function() {
          return t = this._applyWithArgs("between", s, e)
        }));
        return s + t + e
      }).call(this)
    },
