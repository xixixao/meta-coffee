...
define(['./ometa-base', './ometa-lib', 'coffee-script'], function(OMeta, OMLib, BSCoffeeScriptCompiler) {
  var BSDentParser, api, compileAction, extend, subclass, trim;
  subclass = OMLib.subclass, trim = OMLib.trim, extend = OMLib.extend;
...
"compile":function(){var input,args;return (function(){input=this._apply("anything");args=this._apply("anything");return compileAction(input, args)}).call(this)},
"simplify":function(){var compiled;return (function(){compiled=this._apply("anything");return (function(){
  var exp, lines;
...
"initialize":function(){return (function(){(function(){
  this.dentlevel = 0;
  return this.sep = 'none';
}).call(this);return BSDentParser._superApplyWithArgs(this,'initialize')}).call(this)},
...
"text2":function(){var inside;return (function(){inside=this._apply("anything");return this._or((function(){return this._applyWithArgs("fromTo",'###','###')}),(function(){return this._applyWithArgs("fromTo",'"','"')}),(function(){return this._applyWithArgs("fromTo",'\'','\'')}),(function(){return this._consumedBy((function(){return (function(){this._applyWithArgs("exactly","/");this._many1((function(){return this._or((function(){return (function(){switch(this._apply('anything')){case "\\":return this._or((function(){return (function(){switch(this._apply('anything')){case "\\":return '\\\\';default: throw this.fail}}).call(this)}),(function(){return (function(){'\\';return this._applyWithArgs("exactly","/")}).call(this)}));default: throw this.fail}}).call(this)}),(function(){return (function(){this._not((function(){return this._applyWithArgs("exactly",'\n')}));this._not((function(){return this._applyWithArgs("exactly","/")}));return this._apply("char")}).call(this)}))}));return this._applyWithArgs("exactly","/")}).call(this)}))}),(function(){return (function(){this._pred(inside);this._not((function(){return this._apply("delims")}));return this._apply("text3")}).call(this)}),(function(){return (function(){this._not((function(){return this._applyWithArgs("exactly",'\n')}));this._not((function(){return this._apply("delims")}));this._not((function(){return this._applyWithArgs("apply",this.sep)}));return this._apply("anything")}).call(this)}),(function(){return this._apply("pair")}))}).call(this)},
...
"semAction":function(){var p,args,e;return (function(){p=this._apply("anything");args=this._apply("anything");this.dentlevel = p;return this._or((function(){return this._apply("delimSemAction")}),(function(){return (function(){this._apply("spaces");e=this._applyWithArgs("exp",p);return this._applyWithArgs("foreign",BSCSParser,'action',e,args)}).call(this)}))}).call(this)}});;
