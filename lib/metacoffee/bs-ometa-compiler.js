define([ "./ometa-base", "./ometa-lib" ], function(OMeta, OMLib) {
    ...
    subclass = OMLib.subclass, propertyNames = OMLib.propertyNames, unescape = OMLib.unescape, 
    programString = OMLib.programString, Set = OMLib.Set, extend = OMLib.extend;
    ...
    BSOMetaParser = subclass(BSDentParser, {
        ...
        expr5: function() {
            ...
            return this._or(function() {
                return function() {
                    x = this._applyWithArgs("expr4", !0);
                    xs = this._many1(function() {
                        return function() {
                            this._applyWithArgs("token", "|");
                            return this._applyWithArgs("expr4", !0);
                        }.call(this);
                    });
                ...
                return this._applyWithArgs("expr4", !1);
            });
        },
        expr4: function() {
            var ne, xs, act;
        ...
        rulePart: function() {
            ...
            return function() {
                ...
                this._pred(n === rn);
                b1 = this._applyWithArgs("expr4", !1);
                return this._or(function() {
                    return function() {
                        this._apply("spaces");
                        p = this._apply("linePos");
    ...
    BSOMetaTranslator.prototype.jumpTableCode = function(cases) {
        ...
        return "(function(){switch(this._apply('anything')){" + function() {
            ...
            _results = [];
            for (_i = 0, _len = cases.length; _len > _i; _i++) {
