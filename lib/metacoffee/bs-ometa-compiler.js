...
"charSequence":function(){var xs;return (function(){this._applyWithArgs("exactly","\"");xs=this._many((function(){return (function(){this._not((function(){return this._applyWithArgs("exactly","\"")}));return this._apply("escapedChar")}).call(this)}));this._applyWithArgs("exactly","\"");return ['App', 'token', programString(xs.join(''))]}).call(this)},
...
"XOr":function(){var $elf=this,_fromIdx=this.input.idx,xs;return (function(){xs=this._many((function(){return this._apply("transFn")}));xs.unshift(programString((this["name"] + ".") + this["rName"]));return ["this._xor(",xs.join(","),")"].join("")}).call(this)},
...
"Grammar":function(){var $elf=this,_fromIdx=this.input.idx,name,sName,rules;return (function(){name=this._apply("anything");sName=this._apply("anything");(this["name"]=name);(this["sName"]=sName);rules=this._many((function(){return this._apply("trans")}));return [name,"=subclass(",sName,",{",rules.join(","),"});"].join("")}).call(this)},
"intPart":function(){var $elf=this,_fromIdx=this.input.idx,mode,part;return (function(){this._form((function(){return (function(){mode=this._apply("anything");return part=this._apply("transFn")}).call(this)}));return ((programString(mode) + ",") + part)}).call(this)},
