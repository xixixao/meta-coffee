...
"trans":function(){var t,ans,xs;return (function(){xs=this._many((function(){return (function(){this._form((function(){return (function(){t=this._apply("anything");return ans=this._applyWithArgs("apply",t)}).call(this)}));return ans}).call(this)}));return compileCoffeeScript(xs.join(''))}).call(this)},
"CoffeeScript":function(){return this._apply("anything")},
